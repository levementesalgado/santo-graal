...
export function YearSelector({ years, selected, onChange }: { years, selected, onChange: (y) => void }) {
  return (
...
export function StateSelector({ states, selected, onChange }: { states, selected, onChange: (s) => void }) {
  return (
...
export function MetricSelector({ current, onChange }: { current, onChange: (m) => void }) {
  const metrics = [
    { id, label, desc: 'Mil sacas de 60kg' },
    { id, label, desc: 'kg por hectare' },
    { id, label, desc: 'Mil hectares' },
  ];
...
export function RangeFilter({ value, onChange }: { value, onChange: (v) => void }) {
  return (
